...
0)	CURRENTLY DOING : SECURE SECRETS STRINGS IN APPSETTINGS JSON,BUILD ENCRYPTION TOOL LIKE ID SERVER CRYPTO AND USE CRYPTED IN APPSETTINGS JSON, READ GMAIL, 
						DF EMAIL ADVISE SECURITY ISSUE
...
6)	READING DOCS TO IMPROVE IDENTITY SERVER IMPLEMENTATION, SHOULD USE JWT CHECK
