...
0)	REMOVE DIRECT DB ACCESS FROM WEB API, DEVELOPING PAGED LIST BUT NEED TO USE IT GENERIC IN CRUD CLASS AND TEST THESE NTIER-DESIGN MODS, THEN IF WORKS MERGE BRANCH
...
9)	SECURITY CRYPTO ALGHORITM SHOULD USE 256 BIT AND MASTER PWD SHOULD BE SAFE PLACED : INTERNAL WEB SERVICE NO DECOMPILABLE
10)	CLEAN CODE: REMOVE UNUSED USINGS FROM ALL CLASSES
