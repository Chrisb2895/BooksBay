...
0)	COMPLETE TO WATCH VIDEOS N TIER APP by GettoeCoding: parte-video 4 di 6 in corso logic, minuto 6:00, 
0)	REMOVE DIRECT DB ACCESS FROM WEB API
0)	SEPARATE IDENTITYSERVER IN ANOTHER PROJECT, REMOVE IT FROM WEB API
